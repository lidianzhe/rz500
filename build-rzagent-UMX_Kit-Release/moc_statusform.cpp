...
static const char qt_meta_stringdata_StatusForm[] = {
    "StatusForm\0\0syncToServer()\0syncTime()\0"
};

void StatusForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        StatusForm *_t = static_cast<StatusForm *>(_o);
        switch (_id) {
        case 0: _t->syncToServer(); break;
...
const QMetaObjectExtraData StatusForm::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject StatusForm::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_StatusForm,
      qt_meta_data_StatusForm, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &StatusForm::getStaticMetaObject() { return staticMetaObject; }
